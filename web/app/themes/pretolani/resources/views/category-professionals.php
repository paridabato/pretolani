    ...
    <section class="page-section section section_nav section-black">
        <div class="section__wrapper wrapper">
            <div class="achievements-nav">
                <a class="achievements-nav__item achievements-nav__item_link title-link" href="/category/achievements/individuals/">Particuliers</a>
                <span class="achievements-nav__item achievements-nav__item_sep"></span>
                <a class="achievements-nav__item achievements-nav__item_link achievements-nav__item_active title-link">Professionnel</a>
            </div>
        </div>
    </section>
