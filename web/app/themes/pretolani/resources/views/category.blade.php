                    ...
                    <div class="flex-block flex-block_text flex-block_bottom">
                        <div class="flex-block__content">
                            <div class="title-block c-white">
                                <div class="section-date wow fadeInUp" data-wow-delay="0.5s">{{ get_the_date('Y') }}</div>
                                <div class="section-title sep-letters">{!! the_title() !!}</div>
                                <a class="title-link wow fadeInLeft" data-wow-delay="1s" href="{{ get_permalink() }}">{{ __('Découvrir', 'sage') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
