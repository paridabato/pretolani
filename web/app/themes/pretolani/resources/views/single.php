      ...
      <div class="flex-row">
        <div class="flex-block flex-block_padd">
          <div class="flex-block__content">
            <div class="description"><p class="sep-lines">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec
                lacinia erat nec tempus. Lorem ipsum dolor sit amet, consectetur adipiscing elit lacinia erat nec
                tempus. Lorem ipsum dolor sit amet, consectetur adipiscing elit</p></div>
          </div>
        </div>
        <div class="flex-block flex-block_padd">
          <div class="flex-block__content">
